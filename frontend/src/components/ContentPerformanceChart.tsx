...
import { Layers, FileText, Image as ImageIcon, Video, HelpCircle } from 'lucide-react';
...
export const ContentPerformanceChart: React.FC<ContentPerformanceProps> = ({
  ...
  return (
    <div id="content-performance-block" className="stat-card p-4 space-y-3">
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-bold text-tg-text">Эффективность форматов контента</h3>
